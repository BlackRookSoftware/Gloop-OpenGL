 ...
 */
public class OGLProgramPipeline extends OGLObject 
{
	...
	/**
	 * Constructs a new Program Pipeline object.
	 */
	OGLProgramPipeline()
	{
		setName(glGenProgramPipelines());
	}

	@Override
	protected void free()
	{
		glDeleteProgramPipelines(getName());
	}
